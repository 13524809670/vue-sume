<template>
  	<div class="three">
  		<h3>【{{ msg }}】</h3>
  		<h4>{{ msg2 }}</h4>
  		<p>QQ：<a href="#">1634208912</a></p>
  		<p>GitHub：<a href="#">@13524809670</a></p>
  		<p>Tel：13524809670</p>
  		<p>微信：<a href="#">13524809670</a></p>
  		<a v-link="{ path: '/' }" class="three-btn">返回首页</a>
  	</div>
	<canvas></canvas>
</template>
...
<script>
 ...
 //    var canvas, ctx, tim, bai;
	...
	// 	  ctx.strokeStyle = ctx.fillStyle = "hsla(210,80%,40%,0.3)";
